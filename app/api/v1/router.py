...
from app.api.v1 import blcpv_keywords
...
api_router.include_router(external_api.mgmt_router, tags=["API Keys"])
...
api_router.include_router(blcpv_keywords.router, tags=["CPV Keywords"])
